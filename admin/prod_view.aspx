...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        UpdateCommand="UPDATE [prod] SET [pname] = @pname, [ptype] = @ptype, [ptext] = @ptext WHERE [pid] = @pid">
        <DeleteParameters>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="圖片" SortExpression="pphoto">
                <EditItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("pphoto") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" Height="96px" 
                        ImageUrl='<%# "upload/" + Eval("pphoto") %>' Width="101px" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="pname" HeaderText="名稱" SortExpression="pname" />
            <asp:BoundField DataField="ptype" HeaderText="類別" SortExpression="ptype" />
            <asp:BoundField DataField="ptext" HeaderText="說明" SortExpression="ptext" />
            <asp:BoundField DataField="pprice" HeaderText="價格" SortExpression="pprice" />
