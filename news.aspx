...
<div class="container">
	...
	<ul class="menu list-unstyled">
			...
			<li class="activate"><a href="#">活動消息</a>
			<ul class="sub-menu list-unstyled">
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">NEWS</h3>
			...
			<div class="blog_main col-md-9">
				<div class="blog_list">
					...
					<div class="col-md-10 blog_left">
						<img src="jpg/1313.jpg" alt="" width="1904" class="auto-style1"/>
						<h4></h4>
                        <h4></h4>
                        <h4></h4>
                        <asp:SqlDataSource ID="SqlDataSource1"
                                ...
                                SelectCommand="SELECT * FROM [news] WHERE ([ntype] = @ntype) ORDER BY [nid] DESC">
                            <SelectParameters>
                                <asp:QueryStringParameter Name="ntype" QueryStringField="type" Type="String" />
                            </SelectParameters>
                            </asp:SqlDataSource>
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="nid" 
                                DataSourceID="SqlDataSource1" Font-Size="Small" Width="656px" CellPadding="4" ForeColor="#333333" GridLines="None" Height="219px">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="ndate" HeaderText="日期" SortExpression="ndate" />
                                    <asp:BoundField DataField="ntitle" HeaderText="標題" SortExpression="ntitle" />
                                    <asp:BoundField DataField="ntext" HeaderText="內文" 
                                        SortExpression="ntext" />
                                </Columns>
