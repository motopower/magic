...
<div class="container">
	<div class="header">
		...
		<ul class="menu list-unstyled">
			...
			<li class="activate"><a href="store.aspx">商家介紹</a></li>
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">商家介紹</h3>
		<ol class="breadcrumb pull-right">
		  <li><a href="index.aspx">回首頁</a></li>
		  <li class="active">商家介紹</li>
		</ol>
		<div class="clearfix"></div>
	</div>
</div>
			...
			<div class="blog_main col-md-9">
				<div class="blog_list">
					<div class="col-md-2 blog_date">
						<span class="date">商家介紹
						<p><p></p></span>
						 
					</div>
					<div class="col-md-10 blog_left">
 <img alt="" src="jpg/map.jpg" />
						<h4></h4>
					 <h4></h4>
                        <h4></h4>
						<table width="80%" border="1" align="center" bordercolor="#62A29E">
                          <tr>
                            <td width="114" bgcolor="#EAF2F1" class="style1">店名</td>
                            <td width="379" class="style2">勝鴻車業Sheng Hong</td>
                          </tr>
                          <tr>
                            <td bgcolor="#EAF2F1" class="style1">地址</td>
                            <td class="style2">三重區力行路二段3號</td>
                          </tr>
                          <tr>
                            <td bgcolor="#EAF2F1" class="style1">電話</td>
                            <td class="style2">03 455 0241</td>
                          </tr>
                          <tr>
                            <td bgcolor="#EAF2F1" class="style1">營業時間</td>
                            <td class="style2">10:00~21:00</td>
                          </tr>
                        </table>
						<div class="read_btn"> <a href="#"></a> </div>
				  </div>
					<div class="clearfix"></div>
				</div>
				<div class="blog_list">
