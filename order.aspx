...
<script runat="server">
    ...
    {
        Response.Redirect("order_ok.aspx");
    }
</script>
			...
			<div class="blog_main col-md-9">
				<div class="blog_list">
					<div class="col-md-2 blog_date">
						<span class="date">預約服務
						<p><p></p></span>
					
					</div>
					<div class="col-md-10 blog_left">
						<!--<a href="single-page.aspx"><img src="jpg/K3.jpg" alt="" width="600" height="285" class="img-responsive"/></a>-->
						<h4>
                            ...
                            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                                ...
                                <Fields>
                                    <asp:TemplateField HeaderText="日期" SortExpression="rdate">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("rdate") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <InsertItemTemplate>
                                            <asp:Calendar ID="Calendar2" runat="server" BackColor="White" 
                                                BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" 
                                                ForeColor="Black" Height="104px" NextPrevFormat="FullMonth" 
                                                SelectedDate='<%# Bind("rdate") %>' Width="276px">
                                        ...
                                        <ItemTemplate>
                                            <asp:Calendar ID="Calendar1" runat="server" BackColor="White" 
                                                ...
                                                SelectedDate='<%# Bind("rdate") %>' Width="350px">
                                                <DayHeaderStyle Font-Bold="True" Font-Size="8pt" />
                                                <NextPrevStyle Font-Bold="True" Font-Size="8pt" ForeColor="#333333" 
                                                    VerticalAlign="Bottom" />
                                                <OtherMonthDayStyle ForeColor="#999999" />
                                    ...
                                    <asp:TemplateField HeaderText="時間" SortExpression="rtime">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("rtime") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <InsertItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("rtime") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
